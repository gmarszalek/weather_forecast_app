...
public class TemplateController extends WeatherDateSegregation implements Initializable {
    ...
    main.ControllerFunctions functions;
    private ActionEvent event;

    @Override
    public void initialize(URL url, ResourceBundle rb) {

        functions = new main.ControllerFunctions(countryLeft, countryRight, cityLeft, cityRight);
    ...
    public void getCitiesListLeft(ActionEvent event) {
        this.event = event;
        String desiredCountryLeft = "";
        desiredCountryLeft = countryLeft.getText();
